...
return function(irc)
	...
	irc:add_command("mnkpq", "ttt_start", function(irc, state, channel, nick)
		irc:run_command(state, channel, "nmkpq_start " .. nick)
	end, false, "string")
	irc:add_command("mnkpq", "ttt", function(irc, state, channel, msg)
		irc:run_command(state, channel, "nmkpq " .. msg)
	end, false, "string")
	irc:add_command("mnkpq", "ttt_stop", function(irc, state, channel, msg)
		irc:run_command(state, channel, "nmkpq_stop")
	end, false, "string")
end