-- https://bitbucket.org/Boolsheet/sil/raw/18a4e1ae9099bca98fc070eaa487b5a8b19a86ba/hash.lua
...
local utils = require("irc.modules.hash.utils")
...
local success, bit32 = pcall(require, "bit32")
if not success then
	bit32 = nil
end
if bit32 then
...
elseif bit and bit.band then
	...
	local bit_lua = require("irc.modules.hash.bit")
