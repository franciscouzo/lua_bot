...
return function()
	local result = {}
	local topics = {{1, 1}, {2, 2}, {1, math.random(3, #newage.patterns - 1)}, {1, #newage.patterns}}
	for _, n_topic in ipairs(topics) do
		local num, topic = unpack(n_topic)
		local topic_patterns = utils.shuffled(newage.patterns[topic])
		for i = 1, num do
